...
find_path(ALLEGRO_INCLUDE
    ...
    PATHS
        ...
        ${WINDOWS_LIB_DIR}/allegro/include
)
...
if (WIN32 OR APPLE)
    # Find binaries (dlls)
    foreach(ALLEGRO_LIB_EACH ${ALLEGRO_LIB_LIST})    
        find_file(${ALLEGRO_LIB_EACH}_BIN
            NAMES
                "${ALLEGRO_LIB_EACH}-${ALLEGRO_VERSION}.dll"
                "${ALLEGRO_LIB_EACH}.dll"
            PATHS
                ${CMAKE_BINARY_DIR}/packages/Allegro.5.*/build/native/${AL_LIB_TYPE}/bin  # NuGet
                ${WINDOWS_LIB_DIR}/allegro/bin
        )
        message("Binary: ${ALLEGRO_LIB_EACH} -> ${${ALLEGRO_LIB_EACH}_BIN}")
        list(APPEND ALLEGRO_BINARIES ${${ALLEGRO_LIB_EACH}_BIN})
        mark_as_advanced(${ALLEGRO_LIB_EACH}_BIN)
    endforeach()
endif()
...
set(ALLEGRO5_BINARIES ${ALLEGRO_BINARIES})
